        ...
        <div className="mx-auto max-w-2xl">
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-muted-foreground">
              Get help with microchip registration, pet search, and more
            </p>
          </div>

          <Card className="border-2 overflow-hidden">
            <CardHeader className="border-b border-border bg-gradient-hero py-4">
              <CardTitle className="flex items-center gap-3 text-white font-display">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-white/20">
                  <MessageCircle className="h-5 w-5 text-white" />
                </div>
                Woo-Huahua Assistant
              </CardTitle>
            </CardHeader>

            <div className="border-b border-border bg-info-light px-4 py-2">
              <p className="text-xs text-info">
                This is an automated assistant for the microchip database. I can connect you to a
          ...
          <div className="mt-6 flex gap-3 rounded-xl bg-muted/50 p-4">
            ...
            <p className="text-sm text-muted-foreground">
              Conversations are logged for quality assurance and compliance. We will connect you to
              a human agent when requested.
            </p>
          </div>
        </div>
      </div>
